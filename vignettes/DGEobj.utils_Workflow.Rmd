...
## Data Exploration: Multi-Dimensional Scaling (Move to DGEobj.plots vignette)
...
```{r MDSplot, eval=FALSE, echo=TRUE, warning=FALSE, message=FALSE, fig.width=5, fig.height=3.5}
...
## tSNE  :  Just an example.  No new DGEtools capabilities showcased here; consider droppping. (Move to DGEobj.plots vignette)
...
## Inspect pvalue histograms   (Move to DGEobj.plots)
...
```{r pvalueHistograms, eval=FALSE, echo=TRUE, warning=FALSE, message=FALSE, fig.height=3}
...
## Count Significant differential genes  (Move to DGEobj.plots)
